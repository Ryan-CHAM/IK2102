            ...
            for w3 in range(0 , 10 - w1 - w2):
                ...
                if (int(wxx - wx * wx) != 0):
                    ...
                    if (rtemp > r2):
                        ...
                        print(w4)
print(r2)
month = int(input("please input the month to forecast:\n"))
forecast_salary = float(afinal * month + bfinal)
if (forecast_salary <= 0):
    print("No valid forecast salary")
if (forecast_salary > 0):
    print("The forecast salary is: ", forecast_salary)